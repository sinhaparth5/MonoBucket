<script lang="ts" module>
	...
	const ICONS_RAW = {
		...
		users: {
			main: 'M3.2 20.2v-1.6a4.4 4.4 0 0 1 4.4-4.4h3.2a4.4 4.4 0 0 1 4.4 4.4v1.6',
			detail: 'M9.2 11.4a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Z M16.4 5.1a3.4 3.4 0 0 1 0 6.4',
			accent: 'M17.6 14.6a4.4 4.4 0 0 1 3.2 4.2v1.4',
			fill: 'M9.2 11.4a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Z',
			brand: true
		},
		activity: {
			main: 'M12 21a9 9 0 1 1 9-9',
			detail: 'M12 7.2V12l3.2 2.1 M20.2 15.4l1.6 3.2-3.4-.6-2.2 2.6-1.6-5.6Z',
			accent: 'M12 3.2h.01',
			fill: 'M12 3a9 9 0 1 1-9 9 9 9 0 0 1 9-9Z',
			brand: true
		},
		...
		edit: {
			main: 'M4 20h4.2L19 9.2a2 2 0 0 0 0-2.8l-1.4-1.4a2 2 0 0 0-2.8 0L4 15.8Z M14.5 6.5l3 3'
		},
